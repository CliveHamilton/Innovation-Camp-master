 ...
 */
package de.hybris.innovation.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(InnovationFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(InnovationFulfilmentProcessConstants.PARENT_PROCESS);
