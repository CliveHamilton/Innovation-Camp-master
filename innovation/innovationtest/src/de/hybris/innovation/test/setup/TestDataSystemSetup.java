 ...
 */
package de.hybris.innovation.test.setup;
...
import de.hybris.innovation.test.constants.InnovationTestConstants;
import de.hybris.innovation.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = InnovationTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/innovationtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/innovationtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/innovationtest/import/cstickets.impex");
			...
			importImpexFile(context, "/innovationtest/import/csquotes.impex");
		}
	}
}
